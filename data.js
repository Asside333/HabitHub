...
const PROGRESSION_CONFIG = {
  dailyTiers: {
    bronze: { minObjectives: 1, bonusXp: 10 },
    silver: { minObjectives: 3, bonusXp: 20 },
    gold:   { minObjectives: 5, bonusXp: 35 },
  },
  streakRules: {
  ...
  weeklyRules: {
    ...
    chestTiers: [
      { id: "wood",    minScore: 8,  bonusXp: 30  },
      { id: "iron",    minScore: 14, bonusXp: 65  },
      { id: "crystal", minScore: 20, bonusXp: 110 },
    ],
  ...
  yearlyRules: {
    ...
    milestoneRewards: [
      { id: "y25", minPoints: 250 },
      { id: "y50", minPoints: 500 },
    ],
  },
  antiExploit: {
    caps: {
    ...
    claimRules: { uniqueByActionAndDate: true },
...
const ECONOMY_CONFIG = {
  ...
  smoothingPresets: {
    relax:    { dailyXpCapBase: 180 },
    standard: { dailyXpCapBase: 120 },
    strict:   { dailyXpCapBase: 90  },
  },
  dailyCapRanges: {
...
const INITIAL_GAME_STATE = {
  v: 1,
  currencies: { xp: 0, totalXp: 0 },
  daily: { dateKey: null, objectivesCompleted: 0, tier: "none", vacationMode: false },
  progress: {
    level: 1,
    streak: 0,
    lastActiveDate: null,
  ...
  cycles: {
    ...
    weeklyArchives: [],
    bossStreak: 0,
    monthly: { monthKey: null, points: 0, badgeId: null },
    yearly:  { yearKey: null,  points: 0, relicsUnlocked: [], milestonesClaimed: [] },
  },
};

HRPG.CONFIG = {
  BASE_QUESTS: [
    { id: "water", title: "Boire 1L d'eau",        xp: 10, effort: 3, icon: "water", createdAt: 1 },
    { id: "walk",  title: "Marcher 20 minutes",     xp: 20, effort: 6, icon: "walk",  createdAt: 2 },
    { id: "read",  title: "Lire 15 minutes",         xp: 15, effort: 5, icon: "book",  createdAt: 3 },
  ],
  ICON_CATALOG: [
  ...
  ui: {
    ...
    levelUpOverlay: { title: "LEVEL UP", ctaLabel: "Continuer" },
  },
};
